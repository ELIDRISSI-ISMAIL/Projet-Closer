...
export class ProductService{
  ...
  public getDemandes(): Observable<Requests[]> {
    ...
    let ab =  this.http.get<Requests[]>("http://"+this.source+":9999/requests/findByAdherent/1",
      {headers : {
        }});
    console.log("http://"+this.source+":9999/requests/findByAdherent/1")
  ...
  public postAdherent(adherent: AdherentPost): Observable<AdherentPost> {
    ...
    return this.http.post<AdherentPost>("http://"+this.source+":9999/adherents/add", body,{headers : {
      }})
      ;
  }
